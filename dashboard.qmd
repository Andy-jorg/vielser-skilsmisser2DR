...
skils_map <- skils_map |> 
  mutate(label_skils_kvinde = paste0(navn, ": ", mean_skilsmisse_alder_Kvinde),
         label_skils_mand = paste0(navn, ": ", mean_skilsmisse_alder_Mand),
...
map_skils <- leaflet(skils_map) |>
  ...
  addPolygons(data = skils_map,
              ...
              labelOptions = labelOptions(
                textsize = "15px",
                direction = "auto"),
              group = "Ægteskabets varighed (Mean)",
              highlightOptions = highlightOptions(
                weight = 4,
                color = "#666",
                dashArray = "",
  ...
  addPolygons(data = skils_map,
              ...
              highlightOptions = highlightOptions(
                ...
                bringToFront = TRUE)) |>
  addLayersControl(
    baseGroups=c("Ægteskabets varighed (Mean)",
...
```{r}
#| title: "Gennemsnitsalder for skilsmisse og ægteskabsvarighed (2023)"
map_skils
```
...
**Note:** Dashboardet er lavet som en del af ansøgningen til DR Analyse.
